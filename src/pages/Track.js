          ...
          {trackContext.selectedTrack ? 
            <section className='flex flex-col items-between m-auto'>
              ...
              <div className='mb-10'>
                ...
                <button onClick={() => trackContext.setSelectedItem(subitem)} className={`${trackContext.selectedItem && subitem.title === trackContext.selectedItem.title ? 'bg-blue-600' : subitem.completed ? 'bg-green-500' : 'bg-red-500'} rounded-lg p-2 m-2 drop-shadow-lg font-bold active:text-black active:bg-gray-300 hover:bg-blue-600 hover:scale-105`}>
